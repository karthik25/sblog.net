...
{
    public class RequestAccountModelMetaData
    {
        ...
        [DisplayName("your message to the administrator")]
        [StringLength(512, ErrorMessage = "Please restrict your message to be more not than 512 characters")]
        public object AuthorMessage { get; set; }
    }
}
