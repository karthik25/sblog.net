...
else{clearUrlFields();}});$('#btnCancel').click(function(){$('.postUrl,.postUrlPrefix').hide();$('.postUrlLabel').show();$('#btnUpdate').hide();$('#btnCancel').hide();});$(document).on('focus','#bitlyLink',function(){$(this).one('mouseup',function(event){event.preventDefault();}).select();});if($('#isPartiallySavable').length==1){setTimeout(function(){savePostOrPage();},30000);}});function clearUrlFields(){$('.postUrlLabel').text('---').unbind('click');$('.postUrlPrefix').text('');$('.postUrlValue').val('');$('.postUrl').val('');}
...
else{$('.brush-not-selected').hide();$('.selected-brushes-title').html('Selected brushes:');}});});$(document).ready(function(){var li=$('li.current');var submnu;if($(li).parent().attr('class')!='no-display sub-menu'){submnu=$(li).find('ul.sub-menu');$(submnu).removeClass('no-display').addClass('display');}
...
$(document).ready(function(){$('#AkismetEnabled').change(function(){$('.akismetAdvancedOptions').toggle();});if($('#AkismetEnabled').is(':checked')){$('.akismetAdvancedOptions').show();}});$(document).ready(function(){$('#forgottenPswd').click(function(e){e.preventDefault();$('#username').val('username');$('#fake-password').show().val('password');$('#passwd').hide();$('#slick-login').hide();$('#slick-forgotten').show();});$('#loginForm').click(function(e){e.preventDefault();$('#results').html('');$('#emailAddress').val('your email address');$('#slick-login').show();$('#slick-forgotten').hide();});$('#btnLogin').click(function(){if($('#username').val().trim()==''||$('#password').val().trim()==''){$('.login-errors').html('Username and/or password is required').show();return false;}
$('.login-errors').hide().html('');return true;});$('#btnForgottenPswd').click(function(){if($.trim($('#emailAddress').val())!=''&&$.trim($('#emailAddress').val())!='your email address'){return true;}
